        ...
        while True:
            ...
            if message["type"] == "audio_chunk":
                ...
                if len(buffer) > int(sample_rate * 0.5):
                    ...
                    # Konversi ke int16 sebelum simpan (volume sesuai)
                    ...
                    # logger.info(f"Saved full recording to {file_path}")
                    ...
                    if result:
                        await manager.send_result(websocket, {
                            ...
                            "data": result
                            # "file_saved": filename
                            # "file_saved": os.path.basename(file_path) if file_path else None
                        })
                buffer = []
